...
var _ = qlnv.GoUnusedProtection__
...
func main() {
  ...
  client := qlnv.NewUnitServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "createUnit":
    ...
    value0 := argvalue0
    fmt.Print(client.CreateUnit(context.Background(), value0))
    fmt.Print("\n")
    break
  case "readUnit":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "ReadUnit requires 1 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.ReadUnit(context.Background(), value0))
    fmt.Print("\n")
    break
  case "updateUnit":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "UpdateUnit requires 1 args")
      flag.Usage()
    }
    arg56 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.UpdateUnit(context.Background(), value0))
    fmt.Print("\n")
    break
  case "deleteUnit":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.DeleteUnit(context.Background(), value0))
    fmt.Print("\n")
    break
  case "getAllMemberOfUnit":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetAllMemberOfUnit requires 1 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.GetAllMemberOfUnit(context.Background(), value0))
    fmt.Print("\n")
    break
  case "getMembersByPage":
    if flag.NArg() - 1 != 3 {
      fmt.Fprintln(os.Stderr, "GetMembersByPage requires 3 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    ...
    value2 := argvalue2
    fmt.Print(client.GetMembersByPage(context.Background(), value0, value1, value2))
    fmt.Print("\n")
    break
  case "":
    Usage()
