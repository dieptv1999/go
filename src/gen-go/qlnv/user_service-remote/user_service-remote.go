...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  void createUser(User u)")
  fmt.Fprintln(os.Stderr, "  User readUser(string userId)")
...
func main() {
  ...
  client := qlnv.NewUserServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "readUser":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "ReadUser requires 1 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.ReadUser(context.Background(), value0))
    fmt.Print("\n")
    break
  case "updateUser":
    if flag.NArg() - 1 != 1 {
  ...
  case "getUnitUser":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetUnitUser requires 1 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.GetUnitUser(context.Background(), value0))
    fmt.Print("\n")
    break
  case "getUserSortedByPage":
    if flag.NArg() - 1 != 3 {
