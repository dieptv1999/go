...
// @Param	body		body  []byte true		"body for file content"
// @Success 200 {string} result
// @Failure 403 body is empty
// @router / [post]
func (u *FileController) Post() {
	request := string(u.Ctx.Input.RequestBody)
	//serveFrames(request)
	fmt.Println(request)
	base64toPng(request)
